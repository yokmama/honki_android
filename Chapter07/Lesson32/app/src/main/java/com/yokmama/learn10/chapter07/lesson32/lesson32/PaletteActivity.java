    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Palette.generateAsync(bitmap, new Palette.PaletteAsyncListener() {
            ...
            public void onGenerated(Palette palette) {
                ...
                //カラーブロックをセット
                setPalletBlock(palette.getLightVibrantColor(Color.TRANSPARENT), R.id.palette1);
                setPalletBlock(palette.getVibrantColor(Color.TRANSPARENT), R.id.palette2);
                setPalletBlock(palette.getDarkVibrantColor(Color.TRANSPARENT), R.id.palette3);
                setPalletBlock(palette.getLightMutedColor(Color.TRANSPARENT), R.id.palette4);
                setPalletBlock(palette.getMutedColor(Color.TRANSPARENT), R.id.palette5);
                setPalletBlock(palette.getDarkMutedColor(Color.TRANSPARENT), R.id.palette6);
            }
        });
